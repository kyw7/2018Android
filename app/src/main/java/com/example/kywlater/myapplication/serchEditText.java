...
public class serchEditText extends android.support.v7.widget.AppCompatEditText {
    private Drawable imgClear;
    private Context mContext;

    public serchEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init() {
        imgClear = mContext.getResources().getDrawable(R.drawable.search2);
